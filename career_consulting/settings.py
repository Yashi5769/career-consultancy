"""
Django settings for career_consulting project.
...
INSTALLED_APPS = [
    ...
    'career.apps.CareerConfig',  # Using app config
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql' if os.getenv('DB_ENGINE') else 'django.db.backends.sqlite3',
...
# Custom settings for career app
CAREER_APP_CONFIG = {
