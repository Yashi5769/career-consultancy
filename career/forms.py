...
from django.core.validators import FileExtensionValidator, MaxValueValidator, EmailValidator # <-- ADD EmailValidator HERE
...
# ... (Your SecureFileField and ResumeUploadForm classes are fine and go here) ...
...
class FeedbackForm(forms.Form):
    ...
    email = forms.EmailField(
        ...
        # --- FIX: Changed forms.EmailValidator to just EmailValidator ---
        validators=[
